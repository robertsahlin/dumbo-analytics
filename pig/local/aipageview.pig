...
%declare LOAD_PATH  'PageView.txt';
%declare STORE_BLOB  'pig';
%declare STORE_PATH  'aipageview';


--timestamp->requester ip address->v1st cookie->u agent->http status code->www.Brand Label->URI->Page Type->pv referrer->pv utmcontent->pv utmmedium->pv utmcampaign->pv utmsource->pv gclid->pv fbref->pv adid->Browser->Browser Type->OS->Device->Screen Resolution
    ...
    USING org.apache.pig.piggybank.storage.avro.AvroStorage('{
            "schema": {
                ...
                "fields": [
					...
					{"name": "page_type","type": ["null","string"]},
					{"name": "next_path","type": ["null","string"]},
					{"name": "previous_path","type": ["null","string"]}
                ]
            }
         }');
